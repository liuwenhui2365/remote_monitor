...
////    所要传输的文件路径
//    private File file = new File("E:liuworkspace/01.txt");
...
{  
    ...
    {  
        ...
        final String path = sanitizeUri(request.getUri()).substring(6); 
         ...
         */  
        response.addHeader("1.txt", request.getUri());  
    ...
    {  
        ...
        return System.getProperty("f:/1.txt") + File.separator + uri;  
    }  
